...
@Converter
public class UserSkillConverter implements AttributeConverter<List<UserSkill>, String> {

  private static final ObjectMapper mapper = new ObjectMapper();

  @Override
  public String convertToDatabaseColumn(List<UserSkill> list) {
    try {
  ...
  @Override
  public List<UserSkill> convertToEntityAttribute(String json) {
    try {
